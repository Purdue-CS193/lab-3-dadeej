...
public class UtilTester {
    ...
    public void testComplexPositivePower() {
        assertEquals(43046721, MathUtils.raiseToPower(3, 15), delta);
        assertEquals(24137569, MathUtils.raiseToPower(17, 5), delta);
        assertEquals(815730721, MathUtils.raiseToPower(13, 7), delta);
    }
    ...
    public void testShortUsername() {
        assertEquals("bxiululu", StringUtils.makePurdueUsername("bo", "xiululu"));
    }

    @Test
    public void testLongUsername() {
        assertEquals("mdecimus-meridius", StringUtils.makePurdueUsername("maximus", "decimus-meridius"));
    }
    ...
    public static final String simpleTextExpunged = "User [DATA EXPUNDGED], you have been entered to win one year's " +
            "free " +
    ...
    public static final String complexTextExpunged = "SCP-173 approached D-class member [DATA EXPUNDGED] at " +
            "approximately 04:07 " +
            "into the testing procedure. [DATA EXPUNDGED] exhibited nervous behavior at first, knowing that it would " +
            "not be" +
            " simple to maintain containment. In spite of being the sole D-class to survive the latest Keter-level " +
            "event throughout the facility, [DATA EXPUNDGED] was able to survive until 07:45 by alternating blinking " +
            "between " +
            "eyes. [DATA EXPUNDGED] ultimately had their neck snapped at 07:48 after Dr. Robertson played a loud air " +
            "horn " +
            "over the intercom. Dr. Robertson claims this was not at all related to the fact that his wife was " +
            "having an affair with D-Class member [DATA EXPUNDGED], and explained that it was part of a \"QA " +
            "procedure " +
            "passed down from higher-ups.\"";
